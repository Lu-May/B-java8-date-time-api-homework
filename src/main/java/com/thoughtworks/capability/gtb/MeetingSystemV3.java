...
public class MeetingSystemV3 {
  ...
  public static void main(String[] args) {
    ...
    ZonedDateTime meetingTimeInBeijing = meetingTimeInLondon.withZoneSameInstant(ZoneId.of("Asia/Beijing"));

    ZonedDateTime now = LocalDateTime.now().atZone(ZoneId.of("Asia/Beijing"));
    if (now.isAfter(meetingTimeInBeijing)) {
      ...
      // 格式化新会议时间
      ZonedDateTime meetingTimeInChicago = meetingTimeInBeijing.withZoneSameInstant(ZoneId.of("America/Chicago"));
